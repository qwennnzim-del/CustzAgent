...
export const CusstzzLogo: React.FC<IconProps> = ({ className }) => (
  <div
    ...
    style={{
      maskImage: "url('https://img.icons8.com/?size=100&id=BM6i7Qnf1bdk&format=png&color=000000')",
      WebkitMaskImage: "url('https://img.icons8.com/?size=100&id=BM6i7Qnf1bdk&format=png&color=000000')",
      maskSize: 'contain',
